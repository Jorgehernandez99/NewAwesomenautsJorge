    ...
    setBuyText: function(){
        ...
        game.data.buytext = new (me.Renderable.extend({
                    ...
                    draw: function(renderer){
                        ...
                        this.font.draw(renderer.getContext(), "W Ability:  Eat Ypur Creep for Health. Current Level: " + game.data.ability2 + "Cost: " + ((game.data.ability2+1)*10), this.pos.x, this.pos.y + 200);
